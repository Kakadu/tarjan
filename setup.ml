...
(* OASIS_START *)
(* DO NOT EDIT (digest: b91c829bbbf0bc4b650e977ead5fe106) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("../testrunner.byte", []))];
          ...
          ("TestReducer",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("../testreducer.byte", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 })
       ];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "testreducer.ml"; });
               Test
                 ({
                     cs_name = "TestReducer";
                     cs_data = PropList.Data.create ();
     ...
     oasis_digest = Some "\026f\249!\2208iV\148\182\130\228|\0283+";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
